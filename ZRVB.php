<?php require_once 'controllers_motivos/c4.php'; ?>
<!DOCTYPE html>
    <html lang="en">
    <head>
    <meta charset="UTF-8">
...
<form action="ZRVB.php" method="post">
  ...
  <option value="Comentario positivo">Comentario positivo</option></select></span><br>
	...
	<p><input type="submit" name="formu_zrvb" value="Enviar formulario" class="wpcf7-form-control has-spinner wpcf7-submit"><span class="wpcf7-spinner"></span></p>
